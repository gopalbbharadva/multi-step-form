...
import { StepCount } from "./components/ui/StepCount";
  ...
  return (
    <div className="relative bg-magnolia h-screen">
      ...
      <div className="absolute top-10 flex justify-center items-center w-full gap-4">
        ...
        <StepCount count={2} className="border border-alabaster text-alabaster p-4" />
        <StepCount count={3} className="border border-alabaster text-alabaster p-4" />
        <StepCount count={4} className="border border-alabaster text-alabaster p-4" />
      </div>
      ...
      >
        ...
        <Typography
          ...
          variant="subheading"
          className="text-coolGray p-0 m-0 text-start leading-6"
        />
