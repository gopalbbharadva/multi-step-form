  ...
  return (
    <div className="relative bg-magnolia h-screen md:flex md:justify-center items-center">
      ...
      <div className="flex justify-start items-start bg-white p-4 rounded-lg gap-10">
        ...
        <div
          className="bg-white rounded-lg flex justify-start items-start py-10 px-6 gap-2 self-stretch
        ...
        >
          ...
          <form
            className="w-full flex flex-col justify-between items-start gap-4 mt-2 h-full">
            <div
